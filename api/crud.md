...
- [Parte 2 Adicionando o método POST e DELETE](#parte-2-adicionando-o-m%c3%a9todo-post-e-delete)
  ...
  - [Inserindo a Gentileza no banco de dados](#inserindo-a-gentileza-no-banco-de-dados)
...
### Inserindo a Gentileza no banco de dados
...
### Move rotas de Gentilezas para o diretório src/routes/tasks
git mv src/routes/tasks.js src/routes/tasks/tasks_get.js
### Duplica arquivo de rotas de Gentilezas
